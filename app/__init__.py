...
def create_app(config_class=Config):
    ...
    from app.routes.pixelcoin import bp as pixelcoin_bp

    app.register_blueprint(index_bp)
    app.register_blueprint(map_bp)
    app.register_blueprint(api_bp)
    app.register_blueprint(errors_bp)
    app.register_blueprint(pixelcoin_bp)
    ...
    if not app.debug and not app.testing:
        ...
        mail_handler = SMTPHandler(
            ...
            toaddrs=app.config['ADMINS'], subject='Pixel Map',
        ...
        if app.config['LOG_TO_STDOUT']:
            ...
            if not os.path.exists('logs'):
                os.mkdir('logs')
            file_handler = RotatingFileHandler('logs/pixelmap.log',
        ...
        app.logger.info('Pixel Map startup')
